...
(i.e., calculate other variables that average) or if you made an error
...
- **Consistent** naming pattern: `energy_r1`, `energy_r2`, `energu_r3`
...
these common manipulations. I find it difficult to intuitively know the
results of a given reshaping procedure. Thus, I regularly use trial and
errors until I can obtain the desired format. I also recommend investing
time into creating functions that do exactly what you need, so that you
can re-use these procedures in your project and avoid the headache of
obtaining a given format.
