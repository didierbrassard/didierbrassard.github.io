...
<details>
<summary>
Expand for cchs_data and bsw overview
</summary>
...
<details>
<summary>
Expand for descriptive statistics
</summary>
...
# ********************************************** #
  ...
  # note: <design = cchs_design_bsw> incorporates sampling and replicate weights in the analysis

# Age + SE
svy_mean_age <- survey::svymean(~AGE, design = cchs_design_bsw)
svy_mean_age
```
...
```
    ...
    ##   SEX   ENERGY       se
    ## 1   1 2214.365 35.46788
    ## 2   2 1625.329 16.73791

``` r
# Proportion of males
svy_sex <- survey::svytable(~SEX,design = cchs_design_bsw)
percent_male <- round(svy_sex[1] / (svy_sex[1]+svy_sex[2])*100,1)
paste0(percent_male,"%")
```
...
<div id="mmzmwlukhe" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#mmzmwlukhe .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#mmzmwlukhe .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#mmzmwlukhe .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#mmzmwlukhe .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#mmzmwlukhe .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#mmzmwlukhe .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#mmzmwlukhe .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#mmzmwlukhe .gt_from_md > :first-child {
  margin-top: 0;
}

#mmzmwlukhe .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#mmzmwlukhe .gt_row_group_first td {
  border-top-width: 2px;
}

#mmzmwlukhe .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#mmzmwlukhe .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#mmzmwlukhe .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#mmzmwlukhe .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#mmzmwlukhe .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#mmzmwlukhe .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#mmzmwlukhe .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#mmzmwlukhe .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#mmzmwlukhe .gt_font_normal {
  font-weight: normal;
}

#mmzmwlukhe .gt_font_bold {
  font-weight: bold;
}

#mmzmwlukhe .gt_font_italic {
  font-style: italic;
}
...
#mmzmwlukhe .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#mmzmwlukhe .gt_indent_1 {
  text-indent: 5px;
}

#mmzmwlukhe .gt_indent_2 {
  text-indent: 10px;
}

#mmzmwlukhe .gt_indent_3 {
  text-indent: 15px;
}

#mmzmwlukhe .gt_indent_4 {
  text-indent: 20px;
}

#mmzmwlukhe .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
variable). Other alternatives to plot underlying data for large data sets include binning or using ggplot extension such as `ggpointdensity::geom_pointdensity()` (not shown).
...
A SAS code to reproduce the R analysis is shown below.
...
<div id="ref-garriguet2018" class="csl-entry">
...
<div id="ref-healthcanada2017" class="csl-entry">
