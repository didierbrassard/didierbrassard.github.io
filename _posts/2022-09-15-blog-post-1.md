...
**TALENT** and **WORK** contributes to (or cause) one to be a
**FIGHTER**.
...
factor potentially contributing to perceived talent) does not affect
one’s work ethic based on my graph. For the purpose of this example, it
is a plausible assumption that whatever genetic factors contribute to
natural raw talent is not something that should cancel work ethic. On
the contrary, if talent affected one’s work ethic (**TALENT-\>WORK**),
it could even push to work more (“*Oh I’m good at this!*”-\>“*Let’s do
more*”). Again, for the purpose of this example, we will assume this
does not happen. Inversely, work ethic cannot affect one’s genetic.
...
correlation was almost 11times weaker (0.06). Clearly, when looking only
