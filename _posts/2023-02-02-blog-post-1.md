...
This is we are trying to estimate with the model after all! In sum,
...
(**?@tbl-rcs-quantile**). Using quantiles that are well-distributed
across the distribution ensures that there is enough information between
knots to model the relationship. Sometimes, it may be useful to have
more than 5 knots especially when dealing time or dates. However, in
most cases, 3 to 5 knots will suffice.

<div id="cfilpprfpx" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#cfilpprfpx .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#cfilpprfpx .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#cfilpprfpx .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#cfilpprfpx .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#cfilpprfpx .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#cfilpprfpx .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#cfilpprfpx .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#cfilpprfpx .gt_from_md > :first-child {
  margin-top: 0;
}

#cfilpprfpx .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#cfilpprfpx .gt_row_group_first td {
  border-top-width: 2px;
}

#cfilpprfpx .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#cfilpprfpx .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#cfilpprfpx .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#cfilpprfpx .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#cfilpprfpx .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#cfilpprfpx .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#cfilpprfpx .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#cfilpprfpx .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#cfilpprfpx .gt_font_normal {
  font-weight: normal;
}

#cfilpprfpx .gt_font_bold {
  font-weight: bold;
}

#cfilpprfpx .gt_font_italic {
  font-style: italic;
}
...
#cfilpprfpx .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#cfilpprfpx .gt_indent_1 {
  text-indent: 5px;
}

#cfilpprfpx .gt_indent_2 {
  text-indent: 10px;
}

#cfilpprfpx .gt_indent_3 {
  text-indent: 15px;
}

#cfilpprfpx .gt_indent_4 {
  text-indent: 20px;
}

#cfilpprfpx .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
you need more details about the analysis of CCHS data.

<details>
<summary>
Expand for survey design details
</summary>
...
cchs_data <- 
  haven::read_sas(data_file = file.path(external_drive,"CCHS_Nutrition_2015_PUMF","Data_Donnee","hs.sas7bdat"),
                  col_select = c(ADM_RNO,WTS_P,DHH_AGE,DHH_SEX,FSDDEKC,PHSGAPA)) |>
...
*Adapted from Statistics Canada, Canadian Community Health Survey -
Nutrition: Public Use Microdata File, 2015, February 2023. This does not
...
$$\text{PHYS_ACT_VIG}=\beta_0+\beta_{AGE}+\beta_{MALE}+\epsilon$$ Once
the restricted cubic spline transformation is applied to age (**4
...
```
    ...
    Coefficients:
         (Intercept)    rcs(AGE, 4)AGE   rcs(AGE, 4)AGE'  rcs(AGE, 4)AGE''  
             4.80199          -0.06869           0.17064          -0.51821  
                MALE  
             1.26574  

    Degrees of Freedom: 11425 Total (i.e. Null);  495 Residual
      (36 observations deleted due to missingness)
    Null Deviance:      186700 
    Residual Deviance: 181500   AIC: 75170
...
```
    ...
    1 (Intercept)       4.80   0.567   0.95  3.69    5.92      8.46     495 2.93e-16
    2 rcs(AGE, 4)AGE   -0.0687 0.0201  0.95 -0.108  -0.0292   -3.42     495 6.77e- 4
    3 rcs(AGE, 4)AGE'   0.171  0.0567  0.95  0.0592  0.282     3.01     495 2.76e- 3
    4 rcs(AGE, 4)AGE'' -0.518  0.180   0.95 -0.872  -0.164    -2.88     495 4.18e- 3
    5 MALE              1.27   0.233   0.95  0.809   1.72      5.44     495 8.38e- 8
...
Once a restricted cubic spline transforamtion is applied, we interpret
...
Bennette, C. & Vickers, A. (2012) Against quantiles: categorization of
continuous variables in epidemiologic research, and its discontents. BMC
Med Res Methodol, 12, 21. doi:10.1186/1471-2288-12-21.

Desquilbet, L. & Mariotti, F. (2010) Dose‐response analyses using
restricted cubic spline functions in public health research. Statistics
in Medicine, 29(9), 1037-1057. doi:10.1002/sim.3841.

Harrell, F. E. (2015) [General Aspects of Fitting Regression
Models](https://doi.org/10.1007/978-3-319-19425-7_2), Regression
Modeling Strategies: With Applications to Linear Models, Logistic and
Ordinal Regression, and Survival Analysis. Cham: Springer International
Publishing, 13-44.

Khan, T. A., Chiavaroli, L., Zurbau, A. & Sievenpiper, J. L. (2019) A
lack of consideration of a dose-response relationship can lead to
erroneous conclusions regarding 100% fruit juice and the risk of
cardiometabolic disease. Eur J Clin Nutr, 73(12), 1556-1560.
doi:10.1038/s41430-019-0514-x.

Perperoglou, A., Sauerbrei, W., Abrahamowicz, M. & Schmid, M. (2019) A
review of spline function procedures in R. BMC Med Res Methodol, 19(1),
46. doi:10.1186/s12874-019-0666-3.
