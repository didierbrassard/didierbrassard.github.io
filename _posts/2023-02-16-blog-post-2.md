...
measurement using a linear regression model (measurement error model). This measurement error
...
coefficient should be -0.102, which is consistent with the true association!
