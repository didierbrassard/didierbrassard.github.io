...
understand and track each step of your analysis is a key part of this
process. The purpose of this blog is to introduce simple tips and tricks
that support reproducible science. More advanced practices are
introduced at last.
...
4.  You can reuse your previous codes for any new analysis. For example,
    ...
    of course, a balance between the flexibility of your code (ensuring
