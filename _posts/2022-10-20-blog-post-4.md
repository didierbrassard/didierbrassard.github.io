...
.cell-output code { white-space: pre-wrap; border: 1px solid grey;
padding: 1em; }
...
These steps are then demonstrated using R code.

``` mermaid

flowchart TD
    A([Target population]) --Sampling--&gt; B(Original&lt;br&gt;study sample)
    B --Resampling&lt;br&gt;&lt;I&gt;B&lt;/I&gt; times--&gt; C(&lt;I&gt;B&lt;/I&gt; bootstrap&lt;br&gt;samples)
    C --&gt; B
    C --Repeat in each&lt;br&gt;bootstrap sample--&gt; D[Analysis]
    D --&gt; C
    D --&gt; E[&lt;I&gt;B&lt;/I&gt; times&lt;br&gt;the statistic of interest&lt;br&gt;for variance&lt;br&gt;estimation via...]
