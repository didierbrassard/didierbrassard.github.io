...
$$ To obtain a mean diet quality score, the population ratio method is
more optimal since the scoring is applied to intakes that reflect
long-term intakes rather than intakes on a given day.
...
HEFI-2019 score based on the sampling weights (i.e., renamed fron
...
including tge normal approximation or percentile method. For simplicity,
